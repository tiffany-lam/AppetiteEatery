...
def get_restaurant():
    ...
    if request.method == 'POST':
        ...
        hours = Hours(sunday = request.json['hours']['sunday'],
            monday = request.json['hours']['monday'],
            tuesday = request.json['hours']['tuesday'],
            wednesday = request.json['hours']['wednesday'],
            thursday = request.json['hours']['thursday'],
            friday = request.json['hours']['friday'],
            saturday = request.json['hours']['saturday'])
...
def update_restaurant(id):
    ...
    if request.method == 'GET':
        ...
        if (restaurant == None or request.args):
            return str(restaurant), 404
