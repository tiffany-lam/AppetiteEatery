                    ...
                    <div className = "row1"> 
                        <div className="col1">
                            ...
                            <div className="form-field">
                                <label>Email: </label>
                                <input value = {this.state.email} type="email" id="email" className="formInput" placeholder="Enter your email" name="email"onChange={this.handleChange} required={true} />
                            </div>
                        </div>
                        <div className = "col1"> 
                        {/* Last name */}
                            <div className="form-field">
                                ...
                                <input value = {this.state.password} type="password" id="pass" className="formInput" placeholder="Enter your password" name="password" onChange={this.handleChange} required={true}/>
                            </div>
                        </div>
                    </div>
