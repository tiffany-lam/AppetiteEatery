/*
  ...
  Description: This functional component renders a review and it's relevant information, such as 
  the review's poster (name and avatar), the date it was posted, and it's contents (review and 
  attached images).
*/
...
const Review = (props) => {
  ...
  return (
    ...
    <section className="review">
      {/* This section contains the user's information in the restaurant card, as well as when 
      they posted the review. */}
      ...
      {/* This section contains the review's contents, such as the review's rating and the 
...
// Export the Review function, which returns a review component that renders a reviews
// information.
