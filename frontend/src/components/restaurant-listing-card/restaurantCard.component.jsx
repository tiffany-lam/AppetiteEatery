/*
  ...
  Description: This functional component renders a restaurant listing card, which contains 
  snippets of important information, such as address/location, ratings (average and amount), 
  restaurant name, and restaurant tags. It also displays an image from the restaurants images. 
  This component is meant to provide a brief summary of each restaurant for user viewing.
*/
...
// This variable is the initial state of the card information, used to render the card when no
// information has been passed into it.
const INITIAL_STATE = {
  ownerid: "",
  website: "",
  restaurantName: "",
...
const RestaurantCard = ({
  ...
  return (
    // This is the parent container of the restaurant card. An article was used as each card can
    // be imported out of the page without a need for context.
    <article
    ...
    >
      ...
      <section className="restaurant-info">
        {/* This div is a wrapper used purely for styling the card's header information, which 
        includes the restaurant name, the restaurants rating, the amount of restaurants, and the 
        restaurants opening date. */}
        <div className="res-header">
          <h2 className="res-name">{restaurant.restaurantName}</h2>
          {/* This div is used purely for styling the cards rating information and opening date 
          to the upper right corner of the card. */}
